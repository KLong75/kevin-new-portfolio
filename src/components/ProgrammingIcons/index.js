  ...
  return (
    <section style={{padding: '10px'}}>
      <Grid container direction='row' spacing={2} justifyContent="space-around" alignItems="center" style={{ padding: ''}}>
        <img width='10%' height='auto' src={javaScriptGif} alt="" />
        <img width='10%' height='auto' src={htmlLogoGif} alt="" />
        <img width='10%' height='auto' src={cssLogoGif} alt="" />
      </Grid>

      <Grid container direction='row' spacing={2} justifyContent="space-around" alignItems="center" style={{ padding: ''}}>
        <img width='10%' height='auto' src={mongoGif} alt="" />
        <img width='10%' height='auto' src={expressGif} alt="" />
        <img width='10%' height='auto' src={reactGif} alt="" />
        <img width='10%' height='auto' src={nodeGif} alt="" />
      </Grid>
